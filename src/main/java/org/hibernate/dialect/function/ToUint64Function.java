...
public class ToUint64Function extends AbstractSqmSelfRenderingFunctionDescriptor {
    ...
    public ToUint64Function(
        ...
        super(
                ...
                StandardFunctionReturnTypeResolvers.invariant( typeConfiguration.getBasicTypeForJavaType(Long.class)),
    ...
    public void render(
        ...
        sqlAppender.appendSql( "toUInt64(" );
        Expression arg;
