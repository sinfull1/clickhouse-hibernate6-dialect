...
public class ArrayReduceFunction extends AbstractSqmSelfRenderingFunctionDescriptor {
    ...
    public ArrayReduceFunction(
        ...
        super(
                ...
                new ArgumentTypesValidator( StandardArgumentsValidators.max( 2 ), ANY, ANY ),
    ...
    public void render(
        ...
        sqlAppender.appendSql( "arrayReduce(" );
        Expression arg;
