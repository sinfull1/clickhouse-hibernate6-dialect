...
public class TopKFunction extends AbstractSqmSelfRenderingFunctionDescriptor {
    ...
    public TopKFunction(
        ...
        super(
                ...
                new ArgumentTypesValidator( StandardArgumentsValidators.exactly( 2 ), INTEGER, STRING ),
