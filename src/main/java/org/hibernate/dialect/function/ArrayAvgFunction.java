...
public class ArrayAvgFunction extends AbstractSqmSelfRenderingFunctionDescriptor {
    ...
    public ArrayAvgFunction(
        ...
        super(
                ...
                StandardFunctionReturnTypeResolvers.invariant( typeConfiguration.getBasicTypeForJavaType(Float.class)),
    ...
    public void render(
        ...
        sqlAppender.appendSql( "arrayAvg(" );
        Expression arg;
